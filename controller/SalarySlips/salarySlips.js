...
export const generateSalarySlip = async (req, res) => {
    ...
    `, [
            ...
            daysInMonth, absentDays, presentDays, absentDaysInMonth, leaveBalanceOpening, leaveTakenInMonth, leaveBalanceClosing, formattedPaySlipMonth, loanOpeningBalance, loanDeductionCurrentMonth, loanBalance, grossSalary, otherBenefits, grossSalaryWithBenefits, totalDeduction, netPay
        ]);
